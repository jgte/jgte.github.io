...
\acro{a.i.}{\emph{ad interim}\acroextra{, temporarily}}
\acro{a.o.}{amongst others}
\acro{ca.}{\emph{circa}\acroextra{, approximately}}
\acro{cf.}{\emph{confer}\acroextra{, compare}}
\acro{e.g.}{\emph{exempli gratia}\acroextra{, for example}}
\acro{etc.}{\emph{et cetera}\acroextra{, and so forth}}
\acro{i.a.}{\emph{inter alia}\acroextra{, amongst others}}
\acro{i.e.}{\emph{id est}\acroextra{, that is}}
\acro{i.o.}{\emph{in illo ordine}\acroextra{, respectively}}
\acro{p.}{page}
\acro{pp.}{pages}
\acro{vs.}{\emph{versus}\acroextra{, against}}
