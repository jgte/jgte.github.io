...
\else
    ...
    \newcommand{\acrodefcite}[4][]{%
      \acrodef{#2.cite}[!use acl with .cite acronyms!]{#3 (#2)#1 \protecting{\citep{#4}\acused{#2}}}%
      \acrodef{#2.citeonly}[!use acl with .citeonly acronyms!]{\protecting{\citep{#4}}}%
		}
  ...
  \ifdefined\UseUrlInAcronyms
    ...
    \newcommand{\acrourl}[3]{%
      \ifdefined\UseExplicitUrlInAcronyms
...
%maybe \unit is already defined
\providecommand{\unit}{}
\renewcommand{\unit}[2]{\ensuremath{{\sf#1}\thickspace{\sf#2}}}
...
%reference frames
\acro{CRF}{Celestial Reference Frame}
\acro{CIRS}{Celestial Intermediate Reference System}
\acro{GRF}{Gradiometer Reference Frame}
\acro{HRF}{Hill Reference Frame}
\acro{ICRS}{International Celestial Reference System}
\acro{LHRF}{Local Horizontally-aligned Reference Frame}
\acro{LORF}{Local Orbital Reference Frame}
\acro{LoSRF}{Line-of-sight Reference Frame}
\acro{SRF}{Satellite Reference Frame}
\acro{TRF}{Terrestrial Reference Frame}

%#
\acro{1D}{uni-dimensional}
\acro{2D}{bi-dimensional}
\acro{3D}{three-dimensional}
\acro{3BP}{Three Body Problem}
\acro{TBP}{Third Body Perturbation}
%A
\acrocite{AA}{Acceleration Approach}{Rummel1979}
\acro{AC}{Analysis Center}
...
\acrocite{AESOP}{Advanced Equation Solver for Parallel Systems}{Gunter2004}
\acro{AFSPC}{Air Force Space Command\acroextra{, redesignated to \ac{USSF}}}
...
\acrocite{AIUB-GRACE02S}{\acs{AIUB} \acs{GRACE}-only static model, version 2}{Jaggi2012}
\acrocite{AIUB-GRACE03S}{\acs{AIUB} \acs{GRACE}-only static model, version 3}{Jaggi2011c}
...
\acrocite[ product]{AOD1B-RL06}{Atmosphere and Ocean De-aliasing \acl{L1B} \acs{RL06}}{Dobslaw2017}
\acrocite{AOTIM-5}{Arctic Ocean Tidal Inverse Model}{Padman2010}
\acrocite{ANGARA}{Analysis of Non-Gravitational Accelerations due to Radiation pressure and Aerodynamics}{Fritsche1998}
...
\acrourl{ASU}{Astronomical Institute\acroextra{ (Astronomick\'y \'ustav), \acs{AVCR},} Ond{\v r}ejov}{www.asu.cas.cz/en}
...
\acrodefcite{Bernese}{Bernese \acs{GNSS} software}{Dach2015}
\acrourl{BGC}{Bristol Glaciology Centre}{www.bristol.ac.uk/geography/research/bgc/}
\acrourl{BIPM}{Bureau International des Poids et Mesures}{www.bipm.org/en/}
...
\acro{CEP}{Celestial Ephemeris Pole}
...
\acro{CIO}{Celestial Intermediate Origin}
\acro{CIP}{Celestial Intermediate Pole}
\acro{CEO}{Celestial Ephemeris Origin} %same as CIO
...
\acrocite{CODE}{Centre for Orbit Determination in Europe}{Dach2017}
...
\acrourl{COST-G}{Combination Service of Time-variable Gravity Fields}{cost-g.org}
\acro{COTS}{Commercial Off-The-Shelf}
\acro{CPR}{Cycle Per Revolution}
\acrodefplural{CPR}{Cycles Per Revolution}
\acro{CPU}{Central Processing Unit}
\acro{CRV}{Code Residual Variation}
\acrourl{CSR}{Center for Space Research\acroextra{, \acs{UT Austin}, \acs{USA}}}{www.csr.utexas.edu}
...
\acrocite{DWM07}{Disturbance Wind Model 07}{Emmert2008a}
%E
\acro{E2E}{End-to-End}
\acro{EARP}{Earth Albedo Radiation Pressure}
...
\acro{EIRP}{Earth Infrared Radiation Pressure}
...
\acrocite{EBA}{Energy Balance Approach}{OKeefe1957,Jekeli1999}
...
\acro{EOT}{Empirical Ocean Tide\acroextra{ model}}
\acrocite{EOT08a}{2008 \acl{EOT} model}{Savcenko2008,Savcenko2008a}
\acrocite{EOT11a}{2011 \acl{EOT} model}{Savcenko2012}
...
\acro{EOP}{Earth Orientation Parameter}
\acrourl{EPSRC}{Engineering and Physical Sciences Research Council}{www.epsrc.ac.uk}
\acrocite{ERBE}{Earth Radiation Budget Experiment}{Barkstrom1986}
\acro{ERA}{Earth Rotation Angle}
\acrourl{ERC}{European Research Council}{erc.europa.eu}
\acro{ERP}{Earth Rotation Parameters}
...
\acrocite{ERA-Interim}{Interim \acs{ECMWF} Re-Analysis}{Dee2011,Berrisford2011}
...
\acrocite[ global tide model]{FES94.1}{1994 \acl{FES}}{LeProvost1994}
\acrocite[ global tide model]{FES95.2}{1995 \acl{FES}}{LeProvost1998}
\acrocite[ global tide model]{FES99}  {1999 \acl{FES}}{Lefevre2002}
\acrocite[ global tide model]{FES2004}{2004 \acl{FES}}{Lyard2006}
\acrocite[ global tide model]{FES2014}{2014 \acl{FES}}{Carrere2015}
...
\acro{GFM}{Gravity Field Model}
\acrourl{GFZ}{German Research Centre for Geosciences \acroextra{, Germany}}{www.gfz-potsdam.de}
\acrocite{GHOST}{\acs{GPS} High precision Orbit determination Software Tool}{VanHelleputte2004,Wermuth2010}
\acrocite{GGM02}{\acs{GRACE} Gravity Model 02}{Tapley2005}
\acrocite{GGM03}{\acs{GRACE} Gravity Model 03}{Tapley2007a}
\acrocite{GGM05G}{\acs{GRACE} and \acs{GOCE} Gravity Model 05}{Bettadpur2015}
\acrocite{GGM05C}{Combined \acs{GRACE} Gravity Model 05}{Ries2016}
\acro{GIA}{Glacial Isostatic Adjustment}
\acrocite{GIF48}{\acs{GRACE} Intermediate Field 48}{Ries2011}
...
\acrocite{GOCO06S}{\acs{GOCO} release 06 satellite-only gravity field model}{Kvas2021}
...
\acrocite{GRACE-FO}{\acs{GRACE} Follow On}{Kornfeld2019}
...
\acrocite{GROOPS}{Gravity Recovery Object Oriented Programming System}{Mayer-gurr2020}
...
\acro{GST}{Greenwich Sidereal Time} %same as GAST
\acro{GAST}{Greenwich Apparent Sidereal Time}
\acro{GMST}{Greenwich Mean Sidereal Time}
%H
...
\acrocite{IEBA}{Improved \acl{EBA}}{Shang2015}
\acro{IERS}{International Earth Rotation Service}
\acrocite{IERS2010}{\acs{IERS} Conventions 2010}{Petit2010}
\acro{IF}{Intermediate Frequency}
\acrourl{IfG}{Institute of Geodesy\acroextra{, \acs{TUG},} Graz}{www.ifg.tugraz.at}
\acrourl{IGFS}{International Gravity Field Service}{igfs.topo.auth.gr}
...
\acro{I/O}{Input/Ouput}
\acro{I/Q}{In-phase\slash Quadrature}
\acro{IR}{Infrared Radiation}
...
\acrourl{IGG}{Institut f\"ur Geod\"asie und Geoinformation\acroextra{, Germany}}{www.igg.uni-bonn.de}
   \acro{ITG}{Institut f\"ur Geod\"asie und Geoinformation\acroextra{, Germany}}
\acro{ITSG}{Institute of Theoretical Geodesy and Satellite Geodesy\acroextra{, \acs{aka} \acs{IfG}}}
...
\acrocite{ITSG-GRACE2016}{\acs{ITSG} \acs{GRACE}-only model, 2016}{Mayer-Gurr2016}
\acrourl{ITRF}{International Terrestrial Reference Frame}{itrf.ensg.ign.fr}
\acrocite{ITRF2014}{\acs{ITRF}, version 2014}{Rebischung2016}
...
\acrocite{JB2008}{Jacchia-Bowman 2008}{Bowman2008}
\acrourl{JPL}{Jet Propulsion Laboratory\acroextra{, \acs{USA}}}{www.jpl.nasa.gov}
\acrocite{JPL-PLE}{\acs{JPL} Planetary and Lunar Ephemerides}{Folkner2014}
\acrodefplural{JPL-PLE}{\acs{JPL} Planetary and Lunar Ephemerides}
...
\acrocite{LAMBDA}{Least-squares Ambiguity De-correlation Adjustment}{Teunissen1995}
...
\acrourlc{Licenciate}{Lic.}{Licenciatura\acroextra{ (Licenciate in Engineering, pre-Bologna Accords)}}{en.wikipedia.org/wiki/Licentiate}
...
\acrocite{MLAMBDA}{Modified \acs{LAMBDA} method}{Chang2005}
\acrocite{MODK}{Multiple satellites Orbit Determination using Kalman filtering}{Barneveld2012}
\acrocite{MOG2D-G}{2D Gravity Waves model}{Carrere2003}
\acro{MPP}{Milestone Payment Plan}
\acrocite{MSODP}{Multi-Satellite Orbit Determination Program}{Rim1992}
...
\acro{NCP}{North Celestial Pole}
\acro{NEQ}{Normal Equation}
...
\acrocite{NRLMSISE}{\acroextra{US} Naval Research Laboratory Mass Spectrometer and Incoherent Scatter radar\acroextra{ atmospheric model}}{Picone2002}
\acrocite{NRLMSIS2}{\acroextra{US} Naval Research Laboratory Mass Spectrometer and Incoherent Scatter radar\acroextra{ atmospheric model}, version 2}{Emmert2021}
\acrocite{NRTDM}{Near Real-Time Density Model}{Doornbos2014}
\acrourl{NTP}{Network Time Protocol}{www.ntp.org}
%O
\acro{O-C}[\emph{O-C}]{Observed minus Computed (modelled) measurements}
...
\acro{OMM}{Orbit Mean-Elements Message}
...
\acro{PCV}{Phase Center Variation}
...
\acro{PSO}{Precise \acroextra{or Post-processed }Science Orbit}
...
\acro{RGBoE}{Rules and Guidelines of the Board of Examiners}
...
\acro{RL05}{Release 5}
\acro{RL06}{Release 6}
\acro{ROTI}{Rate of \acs{TEC} Index}
\acro{RL07}{Release 7}
...
\acro{SDS}{Science Data Service}
\acrourl{SES}{School of Earth Science\acroextra{, \acs{OSU}}}{earthsciences.osu.edu}
\acro{SFTP}{Secure File Transfer Protocol}
\acrourl{SINEX}{Solution-Independent Exchange\acroextra{ Format}}{www.iers.org/IERS/EN/Organization/AnalysisCoordinator/SinexFormat/sinex.html}
\acro{SGG}{Satellite Gravity Gradient}
\acro{SG}{Satellite Gradiometry}
\acro{SGP4}{Simplified General Perturbation models}
...
\acrourl{SP3c}{Extended Standard Product 3 Orbit Format}{ftp://igs.org/pub/data/format/sp3c.txt}
\acrocite{SPARTA}{Stochastic Parallel Rarefied-Gas Time-Accurate Analyzer}{Gallis2014}
...
\acro{SSN}{Space Surveilance Network}
...
\acro{TACC}{Texas Advanced Computing Center}
\acro{TAI}{International Atomic Time\acroextra{, from its French name \emph{temps atomique international}}}
...
\acro{TEME}{True Equator Mean Equinox\acroextra{ coordinate system}}
\acro{TER}{Teaching and Examination Regulations}
...
\acrourlc{TU Delft}{TUD}{Delft University of Technology\acroextra{, Netherlands}}{www.tudelft.nl}
...
%U
\acrocite{UCBS}{Uniform Cubic Basis Splines}{DeBoor2001}
...
\acrourl{UT Austin}{University of Texas at Austin}{www.utexas.edu}
\acro{UTC}{Coordinated Universal Time}
\acrourl{UTL}{Technical University of Lisbon}{www.ulisboa.pt/en}
\acro{USA}{United States of America}
\acro{USB}{Universal Serial Bus}
\acro{USSF}{United States Space Force}
%V
\acro{V2}{Version 2\acroextra{ of the \acs{L2PS}}}
\acrocite{VEA}{Variational Equations Approach}{Montenbruck2000}
\acro{VCE}{Variance Component Estimation}
...
%Y
\acrourl{YAML}{YAML Ain't Markup Language}{yaml.org}
%Z
\acro{ZD}{Zero-differenced}
\end{acronym}
%NOTICE: beamer may throw an error if there's no acronyms defined in the main document
