...
% ------ include list of grants -------------------------------

\newtoggle{grants}
\togglefalse{grants}
% \toggletrue{grants}
\newcommand{\grantscv}[2]{\iftoggle{grants}{#1}{#2}}

% ------ include references -------------------------------

\newtoggle{references}
\togglefalse{references}
% \toggletrue{references}
\newcommand{\referencescv}[2]{\iftoggle{references}{#1}{#2}}
...
\procv{}{\referencescv{\input{section_references}}{}}
