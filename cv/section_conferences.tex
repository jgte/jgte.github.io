...
Encarnacao2021,              % Seven years of monthly low-degree gravity field models from Swarm GPS data           EGU 2021
Encarnacao2021a,             % Requirements and user needs in the context of quantum gravimetric satellite missions COM-ESA Workshop oQSG
TeixeiradaEncarnacao2021b,   % Multi-approach gravity field models from Swarm GPS data                 11th Swarm DQW
}
\printbibliography
\end{refsection}
...
TeixeiradaEncarnacao2021a,   % Monthly low-degree gravity field models from Swarm GPS data for the last 7 years  IAG 2021
gunter2010using,
